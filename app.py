...
def main():
    model = configure()
    st.set_page_config(page_title="QueryCanvas", page_icon="robot:")
    ...
    if pages == 'About':
        st.markdown(
            ...
            <div style="text-align:center;">
                <h1>QueryCanvas 2.0🤖</h1>
                <h3>Your Personal SQL Query Assistant</h3>
                <p> Welcome to QueryCanvas! Our project is your personal SQL query assistant powered by Google's Generative AI tools. 
                With QueryCanvas, you can effortlessly generate SQL queries and receive detailed explanations, and also format your for readability and consistency. Let's simplifying your data retrieval process!</p>           
            </div>
            """,
